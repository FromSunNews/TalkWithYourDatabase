...
export const getClassificationResult = async (sessionId: string, question: string): Promise<"ANSWER_NORMAL" | "SEARCH_INTERNET" | "SEARCH_JOB" | string> => {
  ...
  return respone as "ANSWER_NORMAL" | "SEARCH_INTERNET" | "SEARCH_JOB" | string;
} 